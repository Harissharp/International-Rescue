...
function freqency_array($array,$resource_name) {// used for the Graph 
  $total=0;
  foreach ($array as $i) { // itterates over each value within array and checks if the resource name its looking for is within 
    if ($i == $resource_name){
      $total=$total+1;
    }
  }
